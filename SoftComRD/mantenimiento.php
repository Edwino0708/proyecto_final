...
<head>
	...
	<title>Horarios de los tecnicos</title>
</head>
<body>
   <div class="container">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="miMenu">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="citas.php">Mantenimiento</a></li>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
				     ...
				     $result2=mysqli_query($conexion,'SELECT nombre FROM usuarios where tipo="tecnico"');
