		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="miMenu">
				<ul class="nav navbar-nav">						
					<li class="active"><a href="mantenimientotecnico.php">Mantenimientos</a></li>	
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
				     ...
				     $result=mysqli_query($conexion,"SELECT id,horas,usuario FROM horarios where tecnico='$user'");
